...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Welcome to DanceVerse — Confirm your email',
  invite: "You've been invited to DanceVerse",
  magiclink: 'Your DanceVerse login link',
  recovery: 'Set up your DanceVerse password',
  email_change: 'Confirm your email change — DanceVerse',
  reauthentication: 'Your DanceVerse verification code',
}
...
// Configuration
const SITE_NAME = "danceverse"
const SENDER_DOMAIN = "notify.dance-verse.com"
const ROOT_DOMAIN = "dance-verse.com"
const FROM_DOMAIN = "notify.dance-verse.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://danceverse.lovable.app"
