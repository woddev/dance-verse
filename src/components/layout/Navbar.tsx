    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-6 py-5 flex justify-between items-center">
        <Link to="/" className="flex items-center">
          <img src={logo} alt="Dance-Verse" <img src={logo} alt="Dance-Verse" className={`h-5 w-auto shrink-0 transition-all ${transparent ? "invert brightness-0 invert" : ""}`} style={transparent ? { filter: "invert(1) brightness(100)" } : undefined} /> ${transparent ? "invert brightness-0 invert" : ""}`} style={transparent ? { filter: "invert(1) brightness(100)" } : undefined} />
        </Link>
