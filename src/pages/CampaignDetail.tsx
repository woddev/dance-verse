...
function CoverPlayer({ coverUrl, audioSrc, songUrl }: { coverUrl?: string | null; audioSrc?: string | null; songUrl?: string | null }) {
  ...
  return (
    <div className="lg:col-span-1 space-y-2 max-w-xs lg:max-w-sm">
      <div
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-5 flex flex-col justify-center">
                  ...
                  {campaign.status === "completed" ? (
                    ...
                    <Button variant="outline" className="w-full py-6 text-base uppercase bg-background text-foreground border-2 border-foreground font-semibold" onClick={scrollToSubmit}>
                      Submit Your Videos
                    </Button>
                  ) : acceptanceStatus ? (
                    <Button className="w-full py-6 text-base uppercase text-white" style={{ backgroundColor: '#4e804d' }} disabled>
